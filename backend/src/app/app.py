...
def create_app(environment=os.environ['ENVIRONMENT']):
    ...
    # register blueprints
    from src.controllers import user, auth, points_of_sale, driver_status, driver, vehicle_type, vehicle, load_type, orders_status, orders
    ...
    app.register_blueprint(load_type.app)
    app.register_blueprint(orders_status.app)
